...
def maak_recepten():
    ...
    kip_kerrie.voeg_ingredient_toe(Ingredient("kipfilet", 200, "gram"))
    kip_kerrie.voeg_ingredient_toe(Ingredient("basmatirijst", 100, "gram"))
    ...
    gehakt_quiche.voeg_ingredient_toe(Ingredient("rundergehakt", 100, "gram"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("rode paprika", 0.5, "stuk"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("ui", 0.5, "stuk"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("quichedeeg", 1, "vel"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("knoflook", 1, "teentje"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("geraspte kaas", 30, "gram"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("ei", 1, "stuk"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("kookroom", 50, "milliliter"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("zout", 0.25, "theelepel"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("peper", 0.25, "theelepel"))
    gehakt_quiche.voeg_ingredient_toe(Ingredient("tijm", 0.25, "theelepel"))
    ...
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("spaghetti", 100, "gram"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("rundergehakt", 150, "gram"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("ui", 0.5, "stuk"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("knoflook", 1, "teentje"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("tomatenpuree", 1, "eetlepel"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("gezeefde tomaten", 200, "gram"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("basilicum", 0.5, "theelepel"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("oregano", 0.5, "theelepel"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("zout", 0.25, "theelepel"))
    spaghetti_bolognese.voeg_ingredient_toe(Ingredient("peper", 0.25, "theelepel"))
